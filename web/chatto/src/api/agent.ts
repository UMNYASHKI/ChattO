...
export const billing = {
	...
	get: (filter: GetOrganizationBillingsRequest) =>
...
export const billingInfo = {
	create: (data: CreateBillingInfoRequest): Promise<BillingInfoResponse> =>
		requests.post('/BillingInfo', data),
	get: (
		filter: GetBillingInfosRequest
	): Promise<PagingResponse<BillingInfoResponse>> =>
...
export const feed = {
	...
	get: (filter: FeedFilterRequest): Promise<PagingResponse<FeedResponse>> =>
		requests.get('/Feed', { params: { filter } }),
	getUsers: (id: string): Promise<FeedAppUserResponse[]> =>
...
export const group = {
	...
	get: (filter: GroupFilterRequest): Promise<PagingResponse<GroupResponse>> =>
...
export const organization = {
	...
	): Promise<PagingResponse<GetDetailsOrganizationResponse>> =>
		requests.get('/Organization', { params: { filter } }),
	getById: (id: string): Promise<GetDetailsOrganizationResponse> =>
...
export const user = {
	...
	get: (filter: UserFilterRequest): Promise<PagingResponse<UserResponse>> =>
		requests.get('/User', { params: { filter } }),
	getById: (id: string): Promise<UserDetailsResponse> =>
...
export const ticket = {
	...
	): Promise<PagingResponse<TicketResponse>> =>
		requests.get('/Ticket', { params: { filter } }),
	getById: (id: string): Promise<TicketDetailsResponse> =>
